                ...
                <div >
                    {isDropdownOpen && (
                        <div className="fixed  p-2 z-50 top-16 right-5 bg-white dark:bg-gray-700 rounded shadow-lg">
                            ...
                            <a href="/#langages" onClick={handleDropdown} className="block px-4 py-2 text-black dark:text-white hover:bg-slate-100 dark:hover:bg-gray-600 transition-transform hover:scale-105">Languages</a>
